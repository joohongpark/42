...
/*   Updated: 2021/01/12 15:04:13 by joopark          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			ft_canvas_init(t_canvas *canvas)
{
	...
	canvas->sprite_texture[1].img = NULL;
	canvas->sprite_texture[2].img = NULL;
...
void			ft_canvas_set(t_canvas *canvas)
{
	...
	canvas->hud = ft_bonus_img_resize(canvas->window, canvas->hud, w, h);
