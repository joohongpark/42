...
int					ft_stack_sort(t_list **stack_a,
							t_list **stack_b, t_list **pivot);
int					ft_get_center(t_list *stack, int depth, int *val);
int					ft_a_stack_pivot(t_list **sa,
							t_list **sb, int n, int pivot);
int					ft_b_stack_pivot(t_list **sa,
							t_list **sb, int n, int pivot);
int					ft_cmd_n(t_list **sa, t_list **sb, char *cmd, int n);
int					ft_stacka_proc(t_list **sa,
							t_list **sb, t_list **p, int *h);
